...
class EstateImageRepository(private val estateImageDao: EstateImageDao, private val estateId: Int?) {
    val allEstateImageForAEstate: Flow<List<EstateImage>> = estateImageDao.getImagesForAEstate(estateId)
